...
#### When the current highestBidder is outbid by someone else.
#### When someone places a bid greater than highestBindingBid but less than highestBidder's maximum bid.
